...
const FoundationPreview: React.FC = () => {
  return (
    <Section variant="primary">
      ...
      {/* Accent dots */}
      <div className="absolute top-20 left-20 w-3 h-3 bg-red-500/40 rounded-full animate-pulse" />
      <div className="absolute bottom-20 right-20 w-2 h-2 bg-red-500/40 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
