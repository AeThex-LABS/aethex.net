  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-6 gap-12 mb-12">
            ...
            <div className="flex gap-4">
              {[
                ...
                <a
                  key={i}
                  href={social.href}
                  className="w-10 h-10 rounded-lg flex items-center justify-center transition-all hover:scale-110 hover:border-purple-500 hover:text-purple-500"
                  style={{
          ...
          {Object.entries(footerLinks).map(([category, links], colIndex) => (
            <div 
              ...
              style={{ animationDelay: `${0.1 * (colIndex + 1)}s` }}
            >
              <h4 
        ...
        <div 
          className="pt-8 flex flex-col md:flex-row justify-between items-center text-sm gap-4 animate-fade-in"
          style={{ 
            borderTop: '1px solid var(--border-primary)',
            color: 'var(--text-tertiary)',
            animationDelay: '0.5s'
