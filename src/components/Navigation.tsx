...
import { House, GameController, Globe, Briefcase, Users, Code, Pulse } from '@phosphor-icons/react';
...
export const Navigation = () => {
  ...
  const navLinks = [
    ...
    { name: 'Creators', path: '/creators', icon: Briefcase },
    { name: 'Developers', path: '/developers', icon: Code },
    { name: 'Foundation', path: '/foundation', icon: Users }
  ];
