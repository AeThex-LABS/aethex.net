...
import { Globe, MagnifyingGlass, Funnel, Sun, Moon, ArrowLeft } from '@phosphor-icons/react'
...
import { DeveloperPanel } from '@/components/globe/DeveloperPanel'
import { TimezoneLegend } from '@/components/globe/TimezoneLegend'
...
export function GlobePage() {
  ...
  // DEBUG: Log developers data
  useEffect(() => {
    console.log('🌍 Globe Page - Developers:', developers.length, developers)
    console.log('🌍 Globe Page - Loading:', loading)
    console.log('🌍 Globe Page - Error:', error)
  }, [developers, loading, error])
